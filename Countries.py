...
countries = {"Afghanistan":"countryAF",
"Albania":"countryAL","Algeria":"countryDZ",
...
"Argentina":"countryAR",
"Armenia":"countryAM",
"Aruba":"countryAW","Australia":"countryAU",
"Austria":"countryAT","Azerbaijan":"countryAZ",
"Bahamas":"countryBS",
"Bahrain":"countryBH",
...
"Brunei Darussalam":"countryBN","Bulgaria":"countryBG",
"Burkina Faso":"countryBF","Burundi":"countryBI",
"Cambodia":"countryKH",
"Cameroon":"countryCM",
"Canada":"countryCA",
...
def GetCountry(countries):
    """This function return the user Country parameter according to the Google parameters of Countries"""
    input_Country = ''
    try:
        input_Country = input("Write your country in english: ").capitalize()
        while  input_Country not in countries:
             input_Country = input("Please Write a valid country,See the excel file named countries and find your country : ").capitalize()
        else:
        ...
        print("country is not in the database or is bad writing, ", e)
